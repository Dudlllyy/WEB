...
// Данные о сборках с ОБНОВЛЕННЫМИ путями к папке pictures
const buildsData = [
    {
        ...
        img: "../pictures/PC_1.png", specs: { cpu: "Intel Core i5-12400F", gpu: "NVIDIA RTX 3060 8GB", ram: "16GB DDR4", ssd: "512GB M.2" }
    },
    {
        ...
        img: "../pictures/PC_2.png", specs: { cpu: "AMD Ryzen 5 7600X", gpu: "NVIDIA RTX 4060 Ti", ram: "32GB DDR5", ssd: "1TB M.2" }
    },
    {
        ...
        img: "../pictures/PC_3.png", specs: { cpu: "Intel Core i7-14700KF", gpu: "NVIDIA RTX 4080 SUPER", ram: "32GB DDR5", ssd: "2TB M.2" }
    },
    {
        title: "СБОРКА #4", subtitle: "Фокус Эффект", price: "$4,500",
        desc: "Эксклюзивная кастомная сборка с водяным охлаждением премиум-класса.",
        img: "../pictures/PC_4.png", specs: { cpu: "Intel Core i9-14900K", gpu: "NVIDIA RTX 4090 24GB", ram: "64GB DDR5", ssd: "4TB Gen5" }
    },
    {
        title: "СБОРКА #5", subtitle: "Компактная мощь", price: "$1,899",
        desc: "Mini-ITX сборка, которая поместится на любом столе.",
        img: "../pictures/PC_1.png", specs: { cpu: "AMD Ryzen 7 7800X3D", gpu: "NVIDIA RTX 4070 SUPER", ram: "32GB DDR5", ssd: "2TB M.2" }
    },
    {
        title: "СБОРКА #6", subtitle: "Рабочая станция", price: "$3,200",
        desc: "Создана для профессионалов: видеомонтаж, 3D моделирование.",
        img: "../pictures/PC_2.png", specs: { cpu: "AMD Ryzen 9 7950X", gpu: "NVIDIA RTX 4080", ram: "64GB DDR5", ssd: "4TB Gen4" }
    },
    {
        ...
        img: "../pictures/PC_3.png", specs: { cpu: "Intel Core i7-13700K", gpu: "NVIDIA RTX 4070 Ti", ram: "32GB DDR5", ssd: "2TB M.2" }
    },
    {
        ...
        img: "../pictures/PC_4.png", specs: { cpu: "Intel Core i3-12100F", gpu: "NVIDIA RTX 3050", ram: "16GB DDR4", ssd: "512GB M.2" }
    }
];

// ЛОГИКА СЛАЙДЕРА (БЕСКОНЕЧНЫЙ БАРАБАН)
...
function updateCarousel(speed = 500) {
    ...
    infoPanel.style.transitionDuration = '150ms';
...
async function playIntro() {
    ...
    carouselArea.style.setProperty('--trans-speed', `0.5s`);
}
playIntro();
...
function dragEnd(e) {
    ...
    if (dragX < -120) nextSlide();
        ...
        carouselArea.style.setProperty('--drag-x', `0px`);
        carouselArea.style.setProperty('--rot-y', `0deg`);
        setTimeout(() => { carouselArea.classList.remove('is-sliding'); }, 500);
    }
    dragX = 0;
}
